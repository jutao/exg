...
<html>
<head>
<title><s:text name="V_charge_detail.Title.detail" /></title>
...
<script src="edu/jt/exg//js/v_charge_detail.js"></script>
						...
						<s:form id="form1" name="form1" action="" namespace="/">
							...
							<div class="widget_wrap tabby">
								<div class="widget_top">
									...
									<h6>
										<s:text name="V_charge_detail.Title.detail"></s:text>
									</h6>
								</div>
								<fieldset>
									...
									<ul>
										<li class="clearfix">
											<div class="form_grid_4">
												<label class="field_title"><s:text
														name="V_charge_detail.Icon" /></label>
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text name="V_charge_detail.Userkey" /></label>
												<div class="form_input">
											...
											<div class="form_grid_6">
													<label class="field_title"><s:text name="V_charge_detail.Chargeid" /></label>
													<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text name="V_charge_detail.User_id" /></label>
												<div class="form_input">
											...
											<div class="form_grid_6">
													<label class="field_title"><s:text name="V_charge_detail.Name" /></label>
													<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="V_charge_detail.Amount" /></label>
												<div class="form_input">
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="V_charge_detail.Status" /></label>
												<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="V_charge_detail.Category" /></label>
												<div class="form_input">
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="V_charge_detail.Invalid" /></label>
												<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="V_charge_detail.Register_time" /></label>
												<div class="form_input">
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="V_charge_detail.Update_time" /></label>
												<div class="form_input">
