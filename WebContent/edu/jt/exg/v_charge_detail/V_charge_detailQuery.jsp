...
<html>
<head>
<title><s:text name="V_charge_detail.Title.query" /></title>
	...
	<div id="container">
		<div style="overflow: hidden; background-color: #FFF;">
			...
			<s:form id="form1" name="form1"
				action="V_charge_detailAction.action?action=query" namespace="/">
					...
					<div class="top_search" style="position:absolute;z-index:1000;">
						<ul id="search_box">
							<li style="margin-right: 5px;"><s:textfield id="chargeid"
									name="chargeid" cssClass="search_input" style="width:150px;"
									placeholder="请输入充值流水号" /></li>
						...
						<div class="grid_12">
							<div class="widget_wrap tabby">
								<div class="widget_top">
									...
									<h6><s:text name="V_charge_detail_table"/></h6>
								</div>
								<div class="widget_content">
									<s:if test="v_charge_detailList.size()>=0">
										<table id="action_tbl" class="display">
											<thead>
												<tr>
													...
													<th><s:text name="V_charge_detail.Chargeid" /></th>
													<th><s:text name="V_charge_detail.User_id" /></th>
													<th><s:text name="V_charge_detail.Name" /></th>
													<th><s:text name="V_charge_detail.Amount" /></th>
													
													<th><s:text name="V_charge_detail.Category" /></th>
													<th><s:text name="V_charge_detail.Status" /></th>
													<th><s:text name="V_charge_detail.Invalid" /></th>
													<th><s:text name="Common.Control" /></th>
												</tr>
											</thead>
											<tbody>
												<s:iterator value="v_charge_detailList" status="stuts" id="R">
													<tr class="t">
														...
														<td align="center" style="display: none"><s:property value="#R.id" />
															
														</td>		
														<td align="center"><a
																href="V_charge_detailAction.action?action=initupdate&id=<s:property value="#R.id"/>"
																	target="_blank"><s:property value="#R.chargeid" /></a></td>
														...
														<td align="center">
															<a href="V_charge_detailAction.action?action=detail&id=<s:property value="#R.id"/>" target="_self"><img src='<%=basePath%>edu/jt/exg//images/detail.png' border='0' title=<s:text name="Common.Detail"/>></a>
														</td>
													</tr>
												</s:iterator>
											</tbody>
	...
	$(function() {
		$("#form1").submit(function() {
			...
			window.setTimeout(function() {
				window.location = '<%=basePath%>V_charge_detailAction.action?action=initquery';
				return true;
			}, 0);
		});
					$("#delete").click(function() {
			getDeleteAllIds('<%=basePath%>V_charge_detailAction.action?action=deleteSelected&ids=',
