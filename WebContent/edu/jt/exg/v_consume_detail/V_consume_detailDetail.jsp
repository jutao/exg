...
<html>
<head>
<title><s:text name="V_consume_detail.Title.detail" /></title>
...
<script src="edu/jt/exg//js/v_consume_detail.js"></script>
<%-- <script src="edu/jt/exg//js/common.js"></script> --%>
<script language="javascript">
$(function(){
	var location = (window.location+'').split('/'); 
	var bPath = location[0]+'//'+location[2]+'/'+location[3]; 
	var pic = document.getElementById("user_icon1");
	pic.src = bPath+$("#user_icon").val();
	//等待加载editor控件
	//************************************************************************************************************
	...
	$("#s").click(function(){
		if(checkFormForCreateOrUpdate()==true){
			...
			if(ajaxFlag==true){//只要=false就认为有验证不通过
				//防止重复提交
				ShowDiv('fade');
		$("#form1").attr("action", "V_consume_detailAction.action?action=create").submit();
						...
						<s:form id="form1" name="form1" action="" namespace="/">
							...
							<div class="widget_wrap tabby">
								<div class="widget_top">
									...
									<h6>
										<s:text name="V_consume_detail.Title.detail"></s:text>
									</h6>
								</div>
								<fieldset>
									...
									<ul>
										<li class="clearfix">
											<div class="form_grid_4">
												<label class="field_title"><s:text
														name="V_consume_detail.User_icon" /></label>
												<div class="form_input">
													<s:hidden id="user_icon" name="user_icon"></s:hidden>
													<img  id="user_icon1" alt="" src="">
													<span id="user_icon1_valid" class="red">&nbsp;</span>
												</div>
											</div>
										</li>
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="V_consume_detail.Detailid" /></label>
												<div class="form_input">
													<s:textfield id="detailid" name="detailid" readonly="true" />
													<span id="detailid_valid" class="red">&nbsp;</span>
												</div>
											</div>
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="V_consume_detail.Taskkey" /> </label>
												<div class="form_input">
													<s:textfield id="taskkey" name="taskkey" readonly="true" />
													<span id="taskkey_valid" class="red">&nbsp;</span>
												</div>
											</div>
										</li>
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="V_consume_detail.User_name" /></label>
												<div class="form_input">
													<s:textfield id="user_name" name="user_name" readonly="true" />
													<span id="user_name_valid" class="red">&nbsp;</span>
												</div>
											</div>
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="V_consume_detail.User_id" /> </label>
												<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text name="V_consume_detail.Quantity" /> </label>
												<div class="form_input">
													<s:textfield id="quantity" name="quantity" readonly="true" />
													<span id="quantity_valid" class="red">&nbsp;</span>
												</div>
											</div>
											<div class="form_grid_6">
												<label class="field_title"><s:text name="V_consume_detail.Status" /> </label>
												<div class="form_input">
										...
										<li class="clearfix">
											<%-- <div class="form_grid_6">
												<label class="field_title"><s:text
														name="Consume_detail.Status" /> </label>
												<div class="form_input">
													<s:textfield id="status" name="status"
														readonly="true" />
													<br> <span id="status_valid" class="red">&nbsp;</span>
												</div>
											</div> --%>
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="V_consume_detail.Invalid" /> </label>
												<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="V_consume_detail.Register_time" /></label>
												<div class="form_input">
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="V_consume_detail.Update_time" /></label>
												<div class="form_input">
