...
<html>
<head>
<title><s:text name="V_consume_detail.Title.query" /></title>
...
<script src="<%=basePath%>edu/jt/exg//js/v_consume_detail.js"></script>
 ...
 <script language='javascript'>
		...
		$("#reset").click(function() {
			window.setTimeout(function() {
				window.location = '<%=basePath%>V_consume_detailAction.action?action=initquery';
				return true;
			}, 0);
		});
		$("#query_child").click(function(){
			if($('#action_tbl .tr_select input:checked').length==1){
				...
				window.setTimeout(function() {
					window.location = '<%=basePath%>V_consume_detailAction.action?action=query&parent_code='+parent_code;
					return true;
				}, 0);
		...
		$("#delete").click(function() {
			getDeleteAllIds('<%=basePath%>V_consume_detailAction.action?action=deleteSelected&ids=',
...
<div style="overflow: hidden; background-color: #FFF;">
			...
			<s:form id="form1" name="form1"
				action="V_consume_detailAction.action?action=query" namespace="/">
	<div class="page_title gray_sai">
					<div class="top_search" style="position:absolute;z-index:1000;">
						<ul id="search_box">
							<li style="margin-right: 5px;"><s:textfield id="detailid" name="detailid" cssClass="search_input" style="width:100px;"
									placeholder="请输入消费流水号" /></li>
							
							<li style="margin-right: 5px;"><s:textfield id="user_id" name="user_id" cssClass="search_input" style="width:100px;"
									placeholder="请输入用户id" /></li>
							
							<li style="margin-right: 5px;"><s:textfield id="user_name" name="user_name" cssClass="search_input" style="width:100px;"
									placeholder="请输入用户名" /></li>
							
							<li style="margin-right: 5px;"><s:textfield id="status" name="status" cssClass="search_input" style="width:100px;"
									placeholder="请输入状态" /></li>
							
							<li style="margin-right: 5px;"><s:textfield id="invalid" name="invalid" cssClass="search_input" style="width:100px;"
						...
						<div class="grid_12">
							<div class="widget_wrap tabby">
								<div class="widget_top">
									...
									<h6><s:text name="v_consume_detail_table"/></h6>
								</div>
								<div class="widget_content">
							   		<s:if test="v_consume_detailList.size()>=0">         
										<table id="action_tbl" class="display">
											<thead>
												<tr>
													...
													<th><s:text name="V_consume_detail.Detailid" /></th>
													<th><s:text name="V_consume_detail.User_id" /></th>
													<th><s:text name="V_consume_detail.User_name" /></th>
													<th><s:text name="V_consume_detail.Taskkey" /></th>
													<th><s:text name="V_consume_detail.Quantity" /></th>
													<th><s:text name="V_consume_detail.Status" /></th>
													<th><s:text name="V_consume_detail.Invalid" /></th>
													
													<th><s:text name="Common.Control" /></th>
												</tr>
											</thead>
											<tbody>
												<s:iterator value="v_consume_detailList" status="stuts" id="R">
													<tr class="t">
														...
														<td align="center"><a 
																href="V_consume_detailAction.action?action=detail&id=<s:property value="#R.id"/>" 
																target="_self"><s:property value="#R.detailid" /></a></td>
														<td align="center"><s:property value="#R.user_id" /></td>
														<td align="center"><s:property value="#R.user_name" /></td>
														<td align="center"><s:property value="#R.taskkey" /></td>
														<td align="center"><s:property value="#R.quantity" /></td>
														<td align="center"><s:property value="#R.status" /></td>
														<td align="center"><s:property value="#R.invalid" /></td>
														
														<td align="center">
															<a href="V_consume_detailAction.action?action=detail&id=<s:property value="#R.id"/>" target="_self"><img src='<%=basePath%>edu/jt/exg//images/detail.png' border='0' title=<s:text name="Common.Detail"/>></a>
														</td>
													</tr>
												</s:iterator>
											</tbody>
