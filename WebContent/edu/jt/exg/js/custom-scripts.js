...
$(function() {
	...
	"iDisplayLength": 10,
	"oLanguage": {
        "sLengthMenu": "<span class='lenghtMenu'> _MENU_</span><span class='lengthLabel'>每页显示:</span>",	
    },
...
$(function() {
    ...
    nCloneTd.innerHTML = '<img src="com/sk/ryw/images/details_open.png">';
 ...
 $(function() {
                ...
                function showActionsBox(){
                    ...
                    var BoxesChecked = $('#action_tbl .tr_select input:checked').length;
