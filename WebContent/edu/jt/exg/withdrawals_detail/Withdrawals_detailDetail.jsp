...
<html>
<head>
<title><s:text name="Withdrawals_detail.Title.detail" /></title>
						...
						<s:form id="form1" name="form1" action="" namespace="/">
							...
							<div class="widget_wrap tabby">
								<div class="widget_top">
									...
									<h6>
										<s:text name="Withdrawals_detail.Title.detail"></s:text>
									</h6>
								</div>
								<fieldset>
									...
									<ul>
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Withdrawals_detail.Chargeid" /></label>
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Withdrawals_detail.Userkey" /> </label>
												<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text name="Withdrawals_detail.Amount" /> </label>
												<div class="form_input">
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text name="Withdrawals_detail.Status" /> </label>
												<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Withdrawals_detail.Invalid" /> </label>
												<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Withdrawals_detail.Register_time" /></label>
												<div class="form_input">
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Withdrawals_detail.Update_time" /></label>
												<div class="form_input">
