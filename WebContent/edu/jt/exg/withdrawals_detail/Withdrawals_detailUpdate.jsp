...
<html>
<head>
<title><s:text name="Withdrawals_detail.Title.update" /></title>
...
if(checkFormForCreateOrUpdate()==true){
	ShowDiv('zzz');
	$("#form1").attr("action", "Withdrawals_detailAction.action?action=update").submit();
}
});
$("#back").click(function(){
<%-- window.location.href='<%=basePath%>Withdrawals_detailAction.action?action=initquery'; --%>
						...
						<s:form id="form1" name="form1" action="" namespace="/">
							<div class="widget_wrap tabby">
								<div class="widget_top">
									...
									<h6>
										<s:text name="Withdrawals_detail.Title.update"></s:text>
									</h6>
								</div>
								<fieldset>
										...
										<li class="clearfix">
											<div class="form_grid_6" style="display:none">
												<label class="field_title"><s:text
														name="Withdrawals_detail.Id" /><span class="req">*</span></label>
