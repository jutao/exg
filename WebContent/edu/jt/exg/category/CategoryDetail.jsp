						...
						<s:form id="form1" name="form1" action="" namespace="/">
							...
							<div class="widget_wrap tabby">
								<div class="widget_top">
									...
									<h6>
										<s:text name="Category.Title.query"></s:text>
									</h6>
								</div>
								<fieldset>
									...
									<ul>
										<li class="clearfix">
											<div class="form_grid_6">
													<label class="field_title"><s:text name="Category.Code" /></label>
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text name="Category.Name" /></label>
												<div class="form_input">
