...
<html>
<head>
<title><s:text name="V_task.Title.query" /></title>
...
$("#search").dblclick(function() {
		...
		$("#reset").click(function() {
			window.setTimeout(function() {
				window.location = '<%=basePath%>V_taskAction.action?action=initquery';
				return true;
			}, 0);
		});
	...
	<div id="container">
		<div style="overflow: hidden; background-color: #FFF;">
			...
			<s:form id="form1" name="form1"
				action="V_taskAction.action?action=query" namespace="/">
						...
						<div class="grid_12">
							<div class="widget_wrap tabby">
								<div class="widget_top">
									...
									<h6><s:text name="V_tast_table"/></h6>
								</div>
								<div class="widget_content">
									<s:if test="v_taskList.size()>=0">
										<table id="action_tbl" class="display">
											<thead>
												<tr>
													...
													<th><s:text name="V_task.Taskid" /></th>
													<th><s:text name="V_task.User_id" /></th>
													<th><s:text name="V_task.Name" /></th>
													<th><s:text name="V_task.Server_name" /></th>
													<th><s:text name="V_task.Server_price" /></th>
													<th><s:text name="V_task.Total_price" /></th>
													<th><s:text name="V_task.Tip" /></th>
													<th><s:text name="V_task.Epson" /></th>
													<th><s:text name="V_task.Pro_description" /></th>
													<th><s:text name="V_task.Seat" /></th>
													<th><s:text name="V_task.Status" /></th>
													<th><s:text name="V_task.Invalid" /></th>
													<th><s:text name="Common.Control" /></th>
												</tr>
											</thead>
											<tbody>
												<s:iterator value="v_taskList" status="stuts" id="R">
													<tr class="t">
														...
														<td align="center"><a
																	href="V_taskAction.action?action=initquery&orderkey=<s:property value="#R.id"/>" target="_self"><s:property value="#R.taskid" /></a></td>
														<td align="center"><s:property value="#R.user_id" /></td>
														<td align="center"><s:property value="#R.name" /></td>
														<td align="center"><s:property value="#R.server_name" /></td>
														<td align="center"><s:property value="#R.server_price" /></td>
														<td align="center"><s:property value="#R.total_price" /></td>
														<td align="center"><s:property value="#R.tip" /></td>
														<td align="center"><s:property value="#R.epson" /></td>
														<td align="center"><s:property value="#R.pro_description" /></td>
														<td align="center"><s:property value="#R.Seat" /></td>
														<td align="center"><s:property value="#R.status" /></td>
														<td align="center"><s:property value="#R.invalid" /></td>
														<td align="center">
															<a href="V_taskAction.action?action=detail&id=<s:property value="#R.id"/>" target="_self"><img src='<%=basePath%>edu/jt/exg//images/detail.png' border='0' title=<s:text name="Common.Detail"/>></a>
														</td>
													</tr>
												</s:iterator>
											</tbody>
