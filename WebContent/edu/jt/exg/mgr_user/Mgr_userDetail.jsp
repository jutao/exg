...
<html>
<head>
<title><s:text name="Mgr_user.Title_detail" /></title>
						...
						<s:form id="form1" name="form1" action="" namespace="/">
							...
							<div class="widget_wrap tabby">
								<div class="widget_top">
									...
									<h6>
										<s:text name="Mgr_user.Title_detail"></s:text>
									</h6>
								</div>
								<fieldset>
									...
									<ul>
										<li class="clearfix">
											<div class="form_grid_6">
													<label class="field_title"><s:text name="Mgr_user.Userid" /></label>
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text name="Mgr_user.Usertype" /></label>
												<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Mgr_user.Register_time" /></label>
												<div class="form_input">
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Mgr_user.Update_time" /></label>
												<div class="form_input">
