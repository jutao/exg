...
<html>
<head>
<title><s:text name="Advertisements.Title_detail" /></title>
						...
						<s:form id="form1" name="form1" action="" namespace="/">
							...
							<div class="widget_wrap tabby">
								<div class="widget_top">
									...
									<h6>
										<s:text name="Advertisements.Title_detail"></s:text>
									</h6>
								</div>
								<fieldset>
									...
									<%-- 	<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text name="Advertisements.Targetkey" /></label>
												<div class="form_input">
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Advertisements.Category" /></label>
												<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6">
													<label class="field_title"><s:text name="Advertisements.Name" /></label>
													<div class="form_input">
											...
											<div class="form_grid_6">
												...
												<div class="form_input">
													<s:textfield id="url" name="url" readonly="true"/>
										...
										<li class="clearfix">
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Advertisements.Invalid" /></label>
												<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Category.Register_time" /></label>
												<div class="form_input">
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Category.Update_time" /></label>
												<div class="form_input">
