...
<html>
<head>
<title><s:text name="Advertisements.Title.update" /></title>
						...
						<s:form id="form1" name="form1" action="" namespace="/">
							...
							<div class="widget_wrap tabby">
								<div class="widget_top">
									...
									<h6>
										<s:text name="Advertisements.Title.update"></s:text>
									</h6>
								</div>
								<fieldset>
										...
										<li class="clearfix">
											<div class="form_grid_6" style="display:none">
												<label class="field_title"><s:text
														name="Advertisements.Id" /><span class="req">*</span></label>
												...
												<label class="field_title"><s:text
												    ...
												    if(dataSrc2[3]!=null){
														...
														$('#box_icon').diyUpload({
															...
															url:'http://localhost:8012/fileuploadserver/fileupload.php?category=topcarousel&filename='+dataSrc2[3],
									...
									<%-- 	<li class="clearfix">
											...
											<div class="form_grid_6" >
												<label class="field_title"><s:text name="Advertisements.Category" /><span class="req">*</span></label>
												<div class="form_input">
													<s:hidden id="category" name="category"></s:hidden>
													<s:select id="categorySelect" name="categorySelect" list="categoryMap" cssClass="chzn-select" style=" width:200px" />
										...
										<li class="clearfix">
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text name="Advertisements.Invalid" /><span class="req">*</span></label>
												<div class="form_input">
													<s:hidden id="invalid" name="invalid"></s:hidden>
													<s:select id="invalidSelect" name="invalidSelect" list="invalidMap" cssClass="chzn-select" style=" width:200px" />
...
$(function(){
	...
	$("#publish_new").click(function(){
		if(checkFormForCreateOrUpdate()==true){
			ShowDiv('zzz');
			$("#form1").attr("action", "AdvertisementsAction.action?action=update").submit();
		}
	}); 
