...
<html>
<head>
<title><s:text name="Categorymaster.Title.detail" /></title>
						...
						<s:form id="form1" name="form1" action="" namespace="/">
							...
							<div class="widget_wrap tabby">
								<div class="widget_top">
									...
									<h6>
										<s:text name="Categorymaster.Title.detail"></s:text>
									</h6>
								</div>
								<fieldset>
									...
									<ul>
										<li class="clearfix">
											<div class="form_grid_6">
													<label class="field_title"><s:text name="Category_master.Parent_code" /></label>
													<div class="form_input">
														<s:textfield id="parent_code" name="parent_code" readonly="true" />
														<span id="parent_code_valid" class="red">&nbsp;</span>
													</div>
											</div>
											<div class="form_grid_6">
												<label class="field_title"><s:text name="Category_master.Code" /></label>
												<div class="form_input">
													<s:textfield id="code" name="code" readonly="true" />
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Category_master.Name" /></label>
												<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Category_master.Invalid" /></label>
												<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Category_master.Register_time" /></label>
												<div class="form_input">
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Category_master.Update_time" /></label>
												<div class="form_input">
...
$(function(){
	...
	$("#back").click(function(){
		<%-- window.location.href='<%=basePath%>Category_masterAction.action?action=initquery'; --%>
