...
<html>
<head>
<title><s:text name="Categorymaster.Title.create" /></title>
						...
						<s:form id="form1" name="form1" action="" namespace="/">
							...
							<div class="widget_wrap tabby">
								<div class="widget_top">
									...
									<h6>
										<s:text name="Categorymaster.Title.create"></s:text>
									</h6>
								</div>
								<fieldset>
									<legend>
									...
									<ul>
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Category_master.Parent_code" /><span class="req">*</span></label>
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Category_master.Code" /><span class="req">*</span></label>
												<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Category_master.Name" /><span class="req">*</span></label>
												<div class="form_input">
    	...
    	$(function(){
			...
			$("#publish_new").click(function(){
				if(checkFormForCreateOrUpdate()==true){
					$("#status").val("20");
					ShowDiv('fade');
					$("#form1").attr("action", "Category_masterAction.action?action=create").submit();
				}
			});
