...
<html>
<head>
<title><s:text name="Categorymaster.Title.update" /></title>
...
<script
	src="<%=basePath%>edu/jt/exg/js/chart-plugins/jqplot.Category_masterAxisRenderer.min.js"></script>
<script
...
<script src="edu/jt/exg/js/category_master.js"></script>
						...
						<s:form id="form1" name="form1" action="" namespace="/">
							...
							<div class="widget_wrap tabby">
								<div class="widget_top">
									...
									<h6>
										<s:text name="Categorymaster.Title.update"></s:text>
									</h6>
								</div>
								<fieldset>
									...
									<ul>
										<li class="clearfix">
											<div class="form_grid_6" style="display:none">
												<label class="field_title"><s:text
														name="Category_master.Id" /><span class="req">*</span></label>
											...
											<div class="form_grid_6">
													<label class="field_title"><s:text name="Category_master.Parent_code" /><span class="req">*</span></label>
													<div class="form_input">
														<s:textfield id="parent_code" name="parent_code" maxlength="100" />
														<span id="parent_code_valid" class="red">&nbsp;</span>
													</div>
											</div>
											<div class="form_grid_6">
													<label class="field_title"><s:text name="Category_master.Code" /><span class="req">*</span></label>
													<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6"   style="display:none">
												<label class="field_title"><s:text name="Category_master.Id" /><span class="req">*</span></label>
												<div class="form_input">
													<s:textfield id="id" name="id" maxlength="100" />
													<span id="id_valid" class="red">&nbsp;</span>
												</div>
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text name="Category_master.Name" /><span class="req">*</span></label>
												<div class="form_input">
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Category_master.Display" /></label>
												<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Category_master.Invalid" /><span class="req">*</span></label>
												<div class="form_input">
...
$(function(){
	...
	$("#publish_new").click(function(){
		if(checkFormForCreateOrUpdate()==true){
			/* $("#status").val("20"); */
			ShowDiv('fade');
			$("#form1").attr("action", "Category_masterAction.action?action=update").submit();
		}
	});
