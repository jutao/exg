...
<html>
<head>
<title><s:text name="Re_serve.Title.query" /></title>
...
<script src="<%=basePath%>edu/jt/exg//js/re_serve.js"></script>
	...
	<div id="container">
		<div style="overflow: hidden; background-color: #FFF;">
			...
			<s:form id="form1" name="form1"
				action="Re_serveAction.action?action=query" namespace="/">
	<div class="page_title gray_sai">
					<div class="top_search" style="position:absolute;z-index:1000;">
						<ul id="search_box">
							<li style="margin-right: 5px;"><s:textfield id="serveid"
									name="serveid" cssClass="search_input" style="width:150px;"
									placeholder="请输入服务ID" /></li>
						...
						<div class="grid_12">
							<div class="widget_wrap tabby">
								<div class="widget_top">
									...
									<h6><s:text name="Re_serve_table"/></h6>
								</div>
								<div class="widget_content">
									<s:if test="re_serveList.size()>=0">
										<table id="action_tbl" class="display">
											...
											<tbody>
												<s:iterator value="re_serveList" status="stuts" id="R">
													<tr class="t">
														...
														<td align="center"><s:property value="#R.serveid" /></td>
														<td align="center"><a
														...
														<td align="center">
															<a href="Re_serveAction.action?action=detail&id=<s:property value="#R.id"/>" target="_self"><img src='<%=basePath%>edu/jt/exg//images/detail.png' border='0' title=<s:text name="Common.Detail"/>></a>
						                                    <a href="Re_serveAction.action?action=initupdate&id=<s:property value="#R.id"/>" target="_self"><img src='<%=basePath%>edu/jt/exg//images/update.png' border='0' title=<s:text name="Common.Modify"/>></a>
															<a href="Re_serveAction.action?action=delete&id=<s:property value="#R.id"/>" target="_self"><img src ='<%=basePath%>edu/jt/exg//images/del.png' border='0' title=<s:text name="Common.Delete"/> onclick="return rusure('<s:text name="Common.Alert_Del"/>');"/></a>
														</td>
													</tr>
												</s:iterator>
											</tbody>
			...
			finder();
				...
				$("#reset").click(function() {
					window.setTimeout(function() {
						window.location = '<%=basePath%>Re_serveAction.action?action=initquery';
						return true;
					}, 0);
				});
				...
				$("#create_parent").click(function() {
					window.setTimeout(function() {
						window.location = '<%=basePath%>Re_serveAction.action?action=initcreate'; 
						return true;
					}, 0);
				});
				$("#delete").click(function() {
					getDeleteAllIds('<%=basePath%>Re_serveAction.action?action=deleteSelected&ids=',
