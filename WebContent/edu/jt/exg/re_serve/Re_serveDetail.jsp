...
<html>
<head>
<title><s:text name="Re_serve.Title.detail" /></title>
...
$(function(){
	...
	var pic = document.getElementById("top_pic11");
	pic.src = bPath+$("#top_pic1").val();
	...
	var location = (window.location+'').split('/'); 
	var bPath = location[0]+'//'+location[2]+'/'+location[3]; 
	var pic = document.getElementById("pic41");
	pic.src = bPath+$("#pic4").val();
	
	var location = (window.location+'').split('/'); 
	var bPath = location[0]+'//'+location[2]+'/'+location[3]; 
	var pic = document.getElementById("pic51");
	pic.src = bPath+$("#pic5").val();
	//等待加载editor控件
	//************************************************************************************************************
	...
	$("#back").click(function(){
		<%-- window.location.href='<%=basePath%>Re_serveAction.action?action=initquery'; --%>
						...
						<s:form id="form1" name="form1" action="" namespace="/">
							...
							<div class="widget_wrap tabby">
								<div class="widget_top">
									...
									<h6>
										<s:text name="Re_serve.Title.detail"></s:text>
									</h6>
								</div>
								<fieldset>
									...
									<ul>
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text name="Re_serve.Description" /> </label>
												<div class="form_input">
													<s:textfield id="description" name="description" readonly="true" />
										...
										<li class="clearfix">
											<div class="form_grid_12">
												...
												<div class="form_input">
													...
													<img  id="top_pic11" alt="" src="">
													<span id="top_pic11_valid" class="red">&nbsp;</span>
												</div>
											</div>
										</li>
										<li class="clearfix">
										...
										<li class="clearfix">
											<div class="form_grid_4">
												...
												<div class="form_input">
													...
													<img  id="pic41" alt="" src="">
													<span id="pic41_valid" class="red">&nbsp;</span>
												</div>
											</div>
											<div class="form_grid_4">
												<label class="field_title"><s:text
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text name="Re_serve.Yubei1" /> </label>
												<div class="form_input">
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text name="Re_serve.Yubei2" /> </label>
												<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text name="Re_serve.Yubei3" /> </label>
												<div class="form_input">
											...
											<div class="form_grid_6">
												...
												<div class="form_input">
													<s:textfield id="display" name="display" readonly="true" />
										...
										<li class="clearfix">
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Re_serve.Register_time" /> </label>
												<div class="form_input">
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text
														name="Re_serve.Update_time" /> </label>
												<div class="form_input">
