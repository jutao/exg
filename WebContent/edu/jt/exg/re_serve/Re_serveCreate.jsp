...
<html>
<head>
<title><s:text name="Re_serve.Title.create" /></title>
						...
						<s:form id="form1" name="form1" action="" namespace="/">
							<div class="widget_wrap tabby">
								<div class="widget_top">
									...
									<h6>
										<s:text name="Re_serve.Title.create"></s:text>
									</h6>
								</div>
								<fieldset>
									<legend>
									...
									<ul>
										<li class="clearfix">
											...
											<div class="form_grid_6">
												<label class="field_title"><s:text name="Re_serve.Name" /><span class="req">*</span></label>
												<div class="form_input">
										...
										<li class="clearfix">
											<div class="form_grid_6">
												...
												<div class="form_input">
													<s:textfield id="yubei1" name="yubei1"
														maxlength="100" />
											...
											<div class="form_grid_6">
												...
												<div class="form_input">
													<s:textfield id="yubei2" name="yubei2"
														maxlength="100" />
										...
										<li class="clearfix">
											<div class="form_grid_6">
												...
												<div class="form_input">
													<s:textfield id="yubei3" name="yubei3"
														maxlength="100" />
