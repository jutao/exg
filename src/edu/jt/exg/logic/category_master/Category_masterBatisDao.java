...
public class Category_masterBatisDao {
	/**
	 * 表或视图名
	 */
	public static String TABLE="category_master";
	/**
	 * 主键升序
	 */
	...
	public static String ID_DESC="id desc";
			public static String PARENT_CODE_ASC="parent_code asc";
		public static String PARENT_CODE_DESC="parent_code desc";
		public static String CODE_ASC="code asc";
		public static String CODE_DESC="code desc";
	...
	/**
	 * 得到ICategory_master接口实例
	 * @return
	 */
	private ICategory_master getICategory_master(){return (ICategory_master)utility.BatisUtility.ctxProxool.getBean("category_masterMapper");}
	
	/**
	 * 查询所有记录
	 * @return
	 */
	public List<Category_masterBean> findByAll(){return getICategory_master().findByAll();}
	 ...
	 * @return
	 */
	public List<Category_masterBean> findByAll(LinkedHashMap<String, String> orderByMap,String start,String range){
        ...
        return getICategory_master().finder(sql.toString());
    }
	 ...
	 * @return long
	 */
	public long findByAllCount(){return getICategory_master().findByAllCount().longValue();}
	 ...
	 * @return
	 */
	public Category_masterBean findByKey(String key){return getICategory_master().findByKey(key);}
	 ...
	 * @return
	 */
	public List<Category_masterBean> finder(LinkedHashMap<String, String> orderByMap,String start,String range,Category_masterBean queryConditionsBean){
	 ...
	 * @return
	 */
	public List<Category_masterBean> finder(LinkedHashMap<String, String> orderByMap,Category_masterBean queryConditionsBean){
		StringBuffer sql=new StringBuffer("select * from "); 
		sql.replace(0, sql.length(), getWhereString(queryConditionsBean,sql.toString()));
		sql.replace(0, sql.length(), Utilities.getOrderByString(orderByMap,sql.toString()));
        return getICategory_master().finder(sql.toString());
	 ...
	 * @return
	 */
	public List<Category_masterBean> finder(Category_masterBean queryConditionsBean){
		StringBuffer sql=new StringBuffer("select * from ");
		sql.replace(0, sql.length(), getWhereString(queryConditionsBean,sql.toString()));
        return getICategory_master().finder(sql.toString());
	}
	 ...
	 * @return long
	 */
	public long finderCount(Category_masterBean queryConditionsBean){
		String sql="select count(1) from ";
		sql=getWhereString(queryConditionsBean,sql);
        return getICategory_master().finderCount(sql).longValue();
	}
	 ...
	 * @return
	 */
	public List<Category_masterBean> finderEqual(Category_masterBean queryConditionsBean){
		StringBuffer sql=new StringBuffer("select * from ");
	 ...
	 * @return
	 */
	public List<Category_masterBean> finderEqual(LinkedHashMap<String, String> orderByMap,Category_masterBean queryConditionsBean){
		StringBuffer sql=new StringBuffer("select * from ");
		sql.replace(0, sql.length(), getEqualWhereString(queryConditionsBean,sql.toString()));
		sql.replace(0, sql.length(), Utilities.getOrderByString(orderByMap,sql.toString()));
        return getICategory_master().finder(sql.toString());
	 ...
	 * @return
	 */
	public List<Category_masterBean> finderEqual(LinkedHashMap<String, String> orderByMap,String start,String range,Category_masterBean queryConditionsBean){
		StringBuffer sql=new StringBuffer("select * from ");
		sql.replace(0, sql.length(), getEqualWhereString(queryConditionsBean,sql.toString()));
		sql.replace(0, sql.length(), Utilities.getOrderByString(orderByMap,sql.toString()));
		try{sql.replace(0, sql.length(), SplitPage.getSqlPage(sql.toString(), Integer.parseInt(start), Integer.parseInt(range), ConstSetup.DATABASE));
	 ...
	 * @return long
	 */
	public long finderEqualCount(Category_masterBean queryConditionsBean){
		String sql="select count(1) from ";
	...
	public int deleteByKey(String key){
		...
		try{getICategory_master().deleteByKey(key);
	...
	public int deleteByKeys(List<String> keys){
		Integer result=new Integer(1);
		try{getICategory_master().deleteByKeys(keys);
	...
	/**
	 * 根据主键更新记录
	 * @param category_masterBean
	 * @return
	 */
	public int updateByKey(Category_masterBean category_masterBean){
		Integer result=new Integer(1);
		try{getICategory_master().updateByKey(category_masterBean);
		}catch(Exception e){result=0;}
		return result.intValue();
	}
	 ...
	 * @return
	 */
	public int insert(Category_masterBean category_masterBean){
		Integer result=new Integer(1);
		try{category_masterBean.setId(Utilities.getRandomPK(true));
			getICategory_master().insert(category_masterBean);
		}catch(Exception e){result=0;}
		return result.intValue();
	}
	...
	/**
	 * 返回sql语句的where子句
	 * @param Category_masterBean 查询条件bean
	 * @param String sql sql语句
	 * @return String sql语句
	 */
	private static String getWhereString(Category_masterBean queryConditionsBean,String sql){
		StringBuffer s=new StringBuffer(sql).append(ConstSetup.DATABASE_OWNER).append(".").append(TABLE).append(" where 1=1 and ");
			...
			s.append("parent_code like '%").append(Utilities.percentMarkFilter(queryConditionsBean.getParent_code().trim())).append("%' escape '/' and ");
		if(queryConditionsBean.getCode().trim().length()>0)
			s.append("code like '%").append(Utilities.percentMarkFilter(queryConditionsBean.getCode().trim())).append("%' escape '/' and ");
	 ...
	 * @return String sql语句
	 */
	private static String getEqualWhereString(Category_masterBean queryConditionsBean,String sql){
		StringBuffer s=new StringBuffer(sql).append(ConstSetup.DATABASE_OWNER).append(".").append(TABLE).append(" where 1=1 and ");
				if(queryConditionsBean.getParent_code().trim().length()>0)
			s.append("parent_code = '").append(Utilities.percentMarkFilter(queryConditionsBean.getParent_code().trim())).append("' and ");
		if(queryConditionsBean.getCode().trim().length()>0)
			s.append("code = '").append(Utilities.percentMarkFilter(queryConditionsBean.getCode().trim())).append("' and ");
		if(queryConditionsBean.getName().trim().length()>0)
