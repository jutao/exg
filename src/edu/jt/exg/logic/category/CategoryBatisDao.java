...
public class CategoryBatisDao {
	...
	public CategoryBatisDao(){super();}
	
	/**
	 * 得到ICategory接口实例
	 * @return
	 */
	private ICategory getICategory(){return (ICategory)utility.BatisUtility.ctxProxool.getBean("categoryMapper");}
	
	/**
	 * 查询所有记录
	 * @return
	 */
	public List<CategoryBean> findByAll(){return getICategory().findByAll();}
	 ...
	 * @return
	 */
	public List<CategoryBean> findByAll(LinkedHashMap<String, String> orderByMap,String start,String range){
        ...
        return getICategory().finder(sql.toString());
    }
	 ...
	 * @return long
	 */
	public long findByAllCount(){return getICategory().findByAllCount().longValue();}
	 ...
	 * @return
	 */
	public CategoryBean findByKey(String key){return getICategory().findByKey(key);}
	 ...
	 * @return
	 */
	public List<CategoryBean> finder(LinkedHashMap<String, String> orderByMap,String start,String range,CategoryBean queryConditionsBean){
	 ...
	 * @return
	 */
	public List<CategoryBean> finder(LinkedHashMap<String, String> orderByMap,CategoryBean queryConditionsBean){
		StringBuffer sql=new StringBuffer("select * from "); 
		sql.replace(0, sql.length(), getWhereString(queryConditionsBean,sql.toString()));
		sql.replace(0, sql.length(), Utilities.getOrderByString(orderByMap,sql.toString()));
        return getICategory().finder(sql.toString());
	 ...
	 * @return
	 */
	public List<CategoryBean> finder(CategoryBean queryConditionsBean){
		StringBuffer sql=new StringBuffer("select * from ");
		sql.replace(0, sql.length(), getWhereString(queryConditionsBean,sql.toString()));
        return getICategory().finder(sql.toString());
	}
	 ...
	 * @return long
	 */
	public long finderCount(CategoryBean queryConditionsBean){
		String sql="select count(1) from ";
		sql=getWhereString(queryConditionsBean,sql);
        return getICategory().finderCount(sql).longValue();
	}
	 ...
	 * @return
	 */
	public List<CategoryBean> finderEqual(CategoryBean queryConditionsBean){
		StringBuffer sql=new StringBuffer("select * from ");
	 ...
	 * @return
	 */
	public List<CategoryBean> finderEqual(LinkedHashMap<String, String> orderByMap,CategoryBean queryConditionsBean){
		StringBuffer sql=new StringBuffer("select * from ");
		sql.replace(0, sql.length(), getEqualWhereString(queryConditionsBean,sql.toString()));
		sql.replace(0, sql.length(), Utilities.getOrderByString(orderByMap,sql.toString()));
        return getICategory().finder(sql.toString());
	 ...
	 * @return
	 */
	public List<CategoryBean> finderEqual(LinkedHashMap<String, String> orderByMap,String start,String range,CategoryBean queryConditionsBean){
		StringBuffer sql=new StringBuffer("select * from ");
		sql.replace(0, sql.length(), getEqualWhereString(queryConditionsBean,sql.toString()));
		sql.replace(0, sql.length(), Utilities.getOrderByString(orderByMap,sql.toString()));
		try{sql.replace(0, sql.length(), SplitPage.getSqlPage(sql.toString(), Integer.parseInt(start), Integer.parseInt(range), ConstSetup.DATABASE));
	 ...
	 * @return long
	 */
	public long finderEqualCount(CategoryBean queryConditionsBean){
		String sql="select count(1) from ";
	...
	public int deleteByKey(String key){
		...
		try{getICategory().deleteByKey(key);
	...
	public int deleteByKeys(List<String> keys){
		Integer result=new Integer(1);
		try{getICategory().deleteByKeys(keys);
	 ...
	 * @return
	 */
	public int updateByKey(CategoryBean categoryBean){
		Integer result=new Integer(1);
		try{getICategory().updateByKey(categoryBean);
		}catch(Exception e){result=0;}
		return result.intValue();
	}
	...
	public int insert(CategoryBean categoryBean){
		Integer result=new Integer(1);
		try{categoryBean.setId(Utilities.getRandomPK(true));
			getICategory().insert(categoryBean);
		}catch(Exception e){result=0;}
		return result.intValue();
	}
	...
	/**
	 * 返回sql语句的where子句
	 * @param CategoryBean 查询条件bean
	 * @param String sql sql语句
	 * @return String sql语句
	 */
	private static String getWhereString(CategoryBean queryConditionsBean,String sql){
	 ...
	 * @return String sql语句
	 */
	private static String getEqualWhereString(CategoryBean queryConditionsBean,String sql){
		StringBuffer s=new StringBuffer(sql).append(ConstSetup.DATABASE_OWNER).append(".").append(TABLE).append(" where 1=1 and ");
				if(queryConditionsBean.getCode().trim().length()>0)
