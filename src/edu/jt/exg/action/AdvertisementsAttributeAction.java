...
public class AdvertisementsAttributeAction extends ActionSupport{
	...
	public AdvertisementsBatisDao batisDao=null;
	 ...
	 * 查询页面显示列表清单
	 */
	public List<AdvertisementsBean> advertisementsList=null;
	public List<AdvertisementsBean> getAdvertisementsList(){return advertisementsList;}
	public void setAdvertisementsList(List<AdvertisementsBean> advertisementsList){this.advertisementsList = advertisementsList;}
