...
public class CategoryAttributeAction extends ActionSupport{
	...
	public CategoryBatisDao batisDao=null;
	 ...
	 * 查询页面显示列表清单
	 */
	public List<CategoryBean> categoryList=null;
	public List<CategoryBean> getCategoryList(){return categoryList;}
	public void setCategoryList(List<CategoryBean> categoryList){this.categoryList = categoryList;}
	/**
	 * action跳转动作
	 */
