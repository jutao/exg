...
public class V_consume_detailAttributeAction extends ActionSupport{
	...
	public V_consume_detailBatisDao batisDao=null;
	 ...
	 * 查询页面显示列表清单
	 */
	public List<V_consume_detailBean> v_consume_detailList=null;
	public List<V_consume_detailBean> getV_consume_detailList(){return v_consume_detailList;}
	public void setV_consume_detailList(List<V_consume_detailBean> v_consume_detailList){this.v_consume_detailList = v_consume_detailList;}
