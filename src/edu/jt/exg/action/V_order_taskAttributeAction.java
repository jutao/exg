...
public class V_order_taskAttributeAction extends ActionSupport{
	...
	public V_order_taskBatisDao batisDao=null;
	 ...
	 * 查询页面显示列表清单
	 */
	public List<V_order_taskBean> v_order_taskList=null;
	public List<V_order_taskBean> getV_order_taskList(){return v_order_taskList;}
	public void setV_order_taskList(List<V_order_taskBean> v_order_taskList){this.v_order_taskList = v_order_taskList;}
