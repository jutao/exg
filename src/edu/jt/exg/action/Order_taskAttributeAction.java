...
public class Order_taskAttributeAction extends ActionSupport{
	...
	public Order_taskBatisDao batisDao=null;
	 ...
	 * 查询页面显示列表清单
	 */
	public List<Order_taskBean> order_taskList=null;
	public List<Order_taskBean> getOrder_taskList(){return order_taskList;}
	public void setOrder_taskList(List<Order_taskBean> order_taskList){this.order_taskList = order_taskList;}
