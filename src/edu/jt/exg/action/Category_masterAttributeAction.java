...
public class Category_masterAttributeAction extends ActionSupport{
	...
	public Category_masterBatisDao batisDao=null;
	 ...
	 * 查询页面显示列表清单
	 */
	public List<Category_masterBean> category_masterList=null;
	public List<Category_masterBean> getCategory_masterList(){return category_masterList;}
	public void setCategory_masterList(List<Category_masterBean> category_masterList){this.category_masterList = category_masterList;}
