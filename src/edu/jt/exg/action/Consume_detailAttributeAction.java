...
public class Consume_detailAttributeAction extends ActionSupport{
	...
	public Consume_detailBatisDao batisDao=null;
	 ...
	 * 查询页面显示列表清单
	 */
	public List<Consume_detailBean> consume_detailList=null;
	public List<Consume_detailBean> getConsume_detailList(){return consume_detailList;}
	public void setConsume_detailList(List<Consume_detailBean> consume_detailList){this.consume_detailList = consume_detailList;}
	...
	//s:textfield
		...
		//for query
		public Double quantityFrom=null;
