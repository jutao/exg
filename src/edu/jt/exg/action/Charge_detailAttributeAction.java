...
public class Charge_detailAttributeAction extends ActionSupport{
	...
	public Charge_detailBatisDao batisDao=null;
	 ...
	 * 查询页面显示列表清单
	 */
	public List<Charge_detailBean> charge_detailList=null;
	public List<Charge_detailBean> getCharge_detailList(){return charge_detailList;}
	public void setCharge_detailList(List<Charge_detailBean> charge_detailList){this.charge_detailList = charge_detailList;}
