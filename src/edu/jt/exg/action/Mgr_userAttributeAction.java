...
public class Mgr_userAttributeAction extends ActionSupport{
	...
	public Mgr_userBatisDao batisDao=null;
	 ...
	 * 查询页面显示列表清单
	 */
	public List<Mgr_userBean> mgr_userList=null;
	public List<Mgr_userBean> getMgr_userList(){return mgr_userList;}
	public void setMgr_userList(List<Mgr_userBean> mgr_userList){this.mgr_userList = mgr_userList;}
	 ...
	 */
		...
		public String usertypeSelect=null;
		public String getUsertypeSelect(){return usertypeSelect;}
		public void setUsertypeSelect(String usertypeSelect){this.usertypeSelect = usertypeSelect;}
