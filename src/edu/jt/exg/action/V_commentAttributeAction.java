...
public class V_commentAttributeAction extends ActionSupport{
	...
	public V_commentBatisDao batisDao=null;
	 ...
	 * 查询页面显示列表清单
	 */
	public List<V_commentBean> v_commentList=null;
	public List<V_commentBean> getV_commentList(){return v_commentList;}
	public void setV_commentList(List<V_commentBean> v_commentList){this.v_commentList = v_commentList;}
