...
import edu.jt.exg.logic.order_master.PageStatus;
...
public class Order_masterAttributeAction extends ActionSupport{
	...
	public Order_masterBatisDao batisDao=null;
	 ...
	 * 查询页面显示列表清单
	 */
	public List<Order_masterBean> order_masterList=null;
	public List<Order_masterBean> getOrder_masterList(){return order_masterList;}
	public void setOrder_masterList(List<Order_masterBean> order_masterList){this.order_masterList = order_masterList;}
