...
import edu.jt.exg.logic.task.PageStatus;
...
public class TaskAttributeAction extends ActionSupport{
	...
	public TaskBatisDao batisDao=null;
	 ...
	 * 查询页面显示列表清单
	 */
	public List<TaskBean> taskList=null;
	public List<TaskBean> getTaskList(){return taskList;}
	public void setTaskList(List<TaskBean> taskList){this.taskList = taskList;}
