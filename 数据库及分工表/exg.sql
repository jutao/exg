...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-02-02 02:09:55
...
(855, '320508', '吴江区', '320500'),
(3145, '320509', '工业园区', '320500'),
(3146, '320510', '高新区', '320500'),
...
CREATE TABLE `category` (
  ...
  `display` int(8) DEFAULT NULL,
  `invalid` varchar(1) NOT NULL,
...
INSERT INTO `category` (`id`, `code`, `name`, `display`, `invalid`, `register_time`, `update_time`) VALUES
('xx0001', '1001', '管理用户类型', 1, '0', NULL, NULL),
('xx0002', '1002', '用户区分', 2, '0', NULL, NULL),
('xx0003', '1003', '已认证资格', 3, '0', NULL, NULL),
('xx0004', '1004', '有效无效区分', 4, '0', NULL, NULL),
('xx0005', '1005', '维修服务类型', 5, '0', NULL, NULL),
('xx0006', '1006', '任务状态', 6, '0', NULL, NULL),
('xx0007', '1007', '接单状态', 7, '0', NULL, NULL),
('xx0008', '1008', '评价区分', 8, '0', NULL, NULL),
('xx0009', '1009', '充值区分', 9, '0', NULL, NULL),
('xx0010', '1010', '充值状态', 10, '0', NULL, NULL),
('xx0011', '1011', '提现状态', 11, '0', NULL, NULL),
('xx0012', '1012', '银行名称', 12, '0', NULL, NULL);

-- --------------------------------------------------------

--
-- 表的结构 `category_master`
--
...
--
-- 转存表中的数据 `category_master`
--

INSERT INTO `category_master` (`id`, `parent_code`, `code`, `name`, `display`, `invalid`, `register_time`, `update_time`) VALUES
('xxx000001', '1001', '10', '管理者', 1, '0', NULL, NULL),
('xxx000002', '1001', '20', '管理员', 2, '0', NULL, NULL),
('xxx000003', '1001', '30', '一般操作者', 3, '0', NULL, NULL),
('xxx000004', '1001', '40', '其他', 4, '0', NULL, NULL),
('xxx000005', '1002', '1', '是', 1, '0', NULL, NULL),
('xxx000006', '1002', '2', '否', 2, '0', NULL, NULL),
('xxx000007', '1003', '10', '锁匠', 1, '0', NULL, NULL),
('xxx000008', '1003', '20', '电工', 2, '0', NULL, NULL),
('xxx000009', '1003', '30', '管道工', 3, '0', NULL, NULL),
('xxx000010', '1003', '40', '无', 4, '0', NULL, NULL),
('xxx000011', '1004', '1', '有效', 1, '0', NULL, NULL),
('xxx000012', '1004', '2', '无效', 2, '0', NULL, NULL),
('xxx000013', '1005', '10', '开锁', 1, '0', NULL, NULL),
('xxx000014', '1005', '20', '家电维修', 2, '0', NULL, NULL),
('xxx000015', '1005', '30', '管道疏通', 3, '0', NULL, NULL),
('xxx000016', '1006', '10', '发布中', 1, '0', NULL, NULL),
('xxx000017', '1006', '20', '进行中', 2, '0', NULL, NULL),
('xxx000018', '1006', '30', '已完成', 3, '0', NULL, NULL),
('xxx000019', '1006', '40', '失败', 4, '0', NULL, NULL),
('xxx000020', '1007', '10', '已接单', 1, '0', NULL, NULL),
('xxx000021', '1007', '20', '已付款', 2, '0', NULL, NULL),
('xxx000022', '1007', '30', '执行中', 3, '0', NULL, NULL),
('xxx000023', '1007', '40', '失败', 4, '0', NULL, NULL),
('xxx000024', '1008', '1', '用户任务评价', 1, '0', NULL, NULL),
('xxx000025', '1008', '2', '维修员接单评价', 2, '0', NULL, NULL),
('xxx000026', '1008', '3', '回复', 3, '0', NULL, NULL),
('xxx000027', '1009', '1', '客户充值', 1, '0', NULL, NULL),
('xxx000028', '1009', '2', '注册返利', 2, '0', NULL, NULL),
('xxx000029', '1010', '10', '未支付', 1, '0', NULL, NULL),
('xxx000030', '1010', '20', '支付中', 2, '0', NULL, NULL),
('xxx000031', '1010', '30', '支付完成', 3, '0', NULL, NULL),
('xxx000032', '1011', '10', '预约中', 1, '0', NULL, NULL),
('xxx000033', '1011', '20', '提现支付中', 2, '0', NULL, NULL),
('xxx000034', '1011', '30', '提现完成', 3, '0', NULL, NULL),
('xxx000035', '1011', '40', '提现失败', 4, '0', NULL, NULL),
('xxx000036', '1012', '10', '中国工商银行', 1, '0', NULL, NULL),
('xxx000037', '1012', '20', '中国银行', 2, '0', NULL, NULL),
('xxx000038', '1012', '30', '中国农业银行', 3, '0', NULL, NULL),
('xxx000039', '1012', '40', '中国建设银行', 4, '0', NULL, NULL),
('xxx000040', '1012', '50', '交通银行', 5, '0', NULL, NULL),
('xxx000041', '1012', '60', '中信银行', 6, '0', NULL, NULL),
('xxx000042', '1012', '70', '中国光大银行', 7, '0', NULL, NULL),
('xxx000043', '1012', '80', '华夏银行', 8, '0', NULL, NULL),
('xxx000044', '1012', '90', '中国民生银行', 9, '0', NULL, NULL),
('xxx000045', '1012', '100', '广发银行', 10, '0', NULL, NULL),
('xxx000046', '1012', '110', '深圳发展银行', 11, '0', NULL, NULL),
('xxx000047', '1012', '120', '招商银行', 12, '0', NULL, NULL),
('xxx000048', '1012', '130', '兴业银行', 13, '0', NULL, NULL),
('xxx000049', '1012', '140', '上海浦东发展银行', 14, '0', NULL, NULL),
('xxx000050', '1012', '150', '恒丰银行', 15, '0', NULL, NULL),
('xxx000051', '1012', '160', '浙商银行', 16, '0', NULL, NULL),
('xxx000052', '1012', '170', '渤海银行', 17, '0', NULL, NULL),
('xxx000053', '1012', '180', '中国邮政储蓄银行', 18, '0', NULL, NULL);
...
CREATE TABLE `mgr_user` (
  ...
  `yubei1` varchar(30) DEFAULT NULL,
  `yubei2` varchar(30) DEFAULT NULL,
  `yubei3` varchar(30) DEFAULT NULL,
  `invalid` varchar(1) NOT NULL,
  `register_time` timestamp NULL DEFAULT NULL,
  `update_time` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `order_master` (
  ...
  `repair_userKey` varchar(64) NOT NULL,
  `outcome` varchar(128) DEFAULT NULL,
  `outcome_image1` varchar(64) DEFAULT NULL,
  `outcome_image2` varchar(64) DEFAULT NULL,
  `outcome_image3` varchar(64) DEFAULT NULL,
  `status` varchar(10) NOT NULL,
  `invalid` varchar(1) NOT NULL,
  `register_time` timestamp NULL DEFAULT NULL,
  `update_time` timestamp NULL DEFAULT NULL
...
CREATE TABLE `re_serve` (
  `id` varchar(64) NOT NULL,
  `serveId` varchar(20) NOT NULL,
  `name` varchar(100) NOT NULL,
  `price` double(15,5) NOT NULL,
  `varieties` varchar(10) NOT NULL,
  `description` varchar(100) NOT NULL,
  `top_pic1` varchar(256) DEFAULT NULL,
  `pic1` varchar(256) DEFAULT NULL,
  `pic2` varchar(256) DEFAULT NULL,
  `pic3` varchar(256) DEFAULT NULL,
...
CREATE TABLE `task` (
  ...
  `tip` double(15,5) NOT NULL,
  `epson` double(15,5) NOT NULL,
  `pro_description` varchar(100) DEFAULT NULL,
  `pro_image1` varchar(64) DEFAULT NULL,
  `pro_image2` varchar(64) DEFAULT NULL,
  `pro_image3` varchar(64) DEFAULT NULL,
  `pro_image4` varchar(64) DEFAULT NULL,
  `pro_image5` varchar(64) DEFAULT NULL,
  `solve_image1` varchar(64) DEFAULT NULL,
  `solve_image2` varchar(64) DEFAULT NULL,
  `solve_image3` varchar(64) DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  `address_province` varchar(60) DEFAULT NULL,
  `address_city` varchar(60) DEFAULT NULL,
  `address_area` varchar(60) DEFAULT NULL,
  `address_details` varchar(60) DEFAULT NULL,
  ...
  `balance` double(15,5) DEFAULT NULL,
  `point` int(11) DEFAULT NULL,
  `recommender_code` varchar(64) DEFAULT NULL,
  `login_password` varchar(64) DEFAULT NULL,
  `gesture_password` varchar(64) DEFAULT NULL,
  `trading_password` varchar(64) DEFAULT NULL,
  `category` varchar(1) NOT NULL,
  `usertype` varchar(10) NOT NULL,
  `qualificat` varchar(256) DEFAULT NULL,
  `yubei1` varchar(30) DEFAULT NULL,
  `yubei2` varchar(30) DEFAULT NULL,
  `yubei3` varchar(30) DEFAULT NULL,
  `invalid` varchar(1) NOT NULL,
...
--
-- 替换视图以便查看 `v_charge_detail`
--
CREATE TABLE `v_charge_detail` (
`id` varchar(64)
,`chargeid` varchar(30)
,`userkey` varchar(64)
,`amount` double(15,5)
...
--
-- 替换视图以便查看 `v_comment_tmp0`
--
CREATE TABLE `v_comment_tmp0` (
`id` varchar(64)
,`userkey` varchar(64)
,`targetkey` varchar(64)
,`detail` varchar(128)
...
--
-- 替换视图以便查看 `v_comment_tmp1`
--
CREATE TABLE `v_comment_tmp1` (
`id` varchar(64)
,`userkey` varchar(64)
,`targetkey` varchar(64)
,`detail` varchar(128)
...
--
-- 替换视图以便查看 `v_comment_tmp2`
--
CREATE TABLE `v_comment_tmp2` (
`id` varchar(64)
,`userkey` varchar(64)
,`targetkey` varchar(64)
,`detail` varchar(128)
...
--
-- 替换视图以便查看 `v_comment_tmp3`
--
CREATE TABLE `v_comment_tmp3` (
`id` varchar(64)
,`userkey` varchar(64)
,`targetkey` varchar(64)
,`detail` varchar(128)
...
--
-- 替换视图以便查看 `v_consume_detail`
--
CREATE TABLE `v_consume_detail` (
`id` varchar(64)
,`detailid` varchar(30)
,`taskkey` varchar(64)
,`quantity` double(15,5)
,`status` varchar(10)
,`invalid` varchar(1)
,`register_time` timestamp
,`update_time` timestamp
...
,`user_id` varchar(20)
,`user_icon` varchar(256)
);

-- --------------------------------------------------------

--
-- 替换视图以便查看 `v_order_master`
--
CREATE TABLE `v_order_master` (
`id` varchar(64)
,`orderid` varchar(30)
,`repair_userKey` varchar(64)
,`outcome` varchar(128)
,`outcome_image1` varchar(64)
,`outcome_image2` varchar(64)
,`outcome_image3` varchar(64)
,`status` varchar(10)
,`invalid` varchar(1)
,`register_time` timestamp
,`update_time` timestamp
,`req_name` varchar(30)
,`req_id` varchar(20)
,`req_icon` varchar(256)
);

-- --------------------------------------------------------

--
-- 替换视图以便查看 `v_order_task`
--
CREATE TABLE `v_order_task` (
`id` varchar(64)
,`taskKey` varchar(64)
,`orderKey` varchar(64)
,`invalid` varchar(1)
...
,`pro_image1` varchar(64)
,`pro_image2` varchar(64)
,`pro_image3` varchar(64)
,`pro_image4` varchar(64)
,`pro_image5` varchar(64)
,`solve_image1` varchar(64)
,`solve_image2` varchar(64)
,`solve_image3` varchar(64)
,`seat` varchar(60)
,`status` varchar(10)
,`invalid` varchar(1)
,`register_time` timestamp
...
,`server_price` double(15,5)
,`total_price` double(22,5)
);

-- --------------------------------------------------------

--
-- 替换视图以便查看 `v_withdrawals_detail`
--
CREATE TABLE `v_withdrawals_detail` (
`id` varchar(64)
,`chargeid` varchar(30)
,`userkey` varchar(64)
,`amount` double(15,5)
...
--
-- 表的结构 `withdrawals_detail`
--

CREATE TABLE `withdrawals_detail` (
  `id` varchar(64) NOT NULL,
  `chargeid` varchar(30) NOT NULL,
  `userkey` varchar(64) NOT NULL,
  `amount` double(15,5) NOT NULL,
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_address`  AS  select `p`.`code` AS `province_code`,`p`.`name` AS `province_name`,`c`.`code` AS `city_code`,`c`.`name` AS `city_name`,`a`.`code` AS `area_code`,`a`.`name` AS `area_name` from ((`area` `a` left join `city` `c` on((`a`.`citycode` = `c`.`code`))) left join `province` `p` on((`c`.`provincecode` = `p`.`code`))) order by `p`.`code`,`c`.`code`,`a`.`code` ;

-- --------------------------------------------------------

--
-- 视图结构 `v_charge_detail`
--
DROP TABLE IF EXISTS `v_charge_detail`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_charge_detail`  AS  select `c`.`id` AS `id`,`c`.`chargeid` AS `chargeid`,`c`.`userkey` AS `userkey`,`c`.`amount` AS `amount`,`c`.`category` AS `category`,`c`.`status` AS `status`,`c`.`invalid` AS `invalid`,`c`.`register_time` AS `register_time`,`c`.`update_time` AS `update_time`,`u`.`name` AS `name`,`u`.`userid` AS `user_id`,`u`.`icon` AS `icon` from (`charge_detail` `c` left join `user` `u` on((`c`.`userkey` = `u`.`id`))) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_comment`  AS  select `v_comment_tmp1`.`id` AS `id`,`v_comment_tmp1`.`userkey` AS `userkey`,`v_comment_tmp1`.`targetkey` AS `targetkey`,`v_comment_tmp1`.`detail` AS `detail`,`v_comment_tmp1`.`pic1` AS `pic1`,`v_comment_tmp1`.`pic2` AS `pic2`,`v_comment_tmp1`.`pic3` AS `pic3`,`v_comment_tmp1`.`category` AS `category`,`v_comment_tmp1`.`display` AS `display`,`v_comment_tmp1`.`invalid` AS `invalid`,`v_comment_tmp1`.`register_time` AS `register_time`,`v_comment_tmp1`.`update_time` AS `update_time`,`v_comment_tmp1`.`user_key` AS `user_key`,`v_comment_tmp1`.`neckname` AS `neckname`,`v_comment_tmp1`.`icon` AS `icon`,`v_comment_tmp1`.`user_id` AS `user_id`,`v_comment_tmp1`.`target_id` AS `target_id`,`v_comment_tmp1`.`target_name` AS `target_name` from `v_comment_tmp1` union all select `v_comment_tmp2`.`id` AS `id`,`v_comment_tmp2`.`userkey` AS `userkey`,`v_comment_tmp2`.`targetkey` AS `targetkey`,`v_comment_tmp2`.`detail` AS `detail`,`v_comment_tmp2`.`pic1` AS `pic1`,`v_comment_tmp2`.`pic2` AS `pic2`,`v_comment_tmp2`.`pic3` AS `pic3`,`v_comment_tmp2`.`category` AS `category`,`v_comment_tmp2`.`display` AS `display`,`v_comment_tmp2`.`invalid` AS `invalid`,`v_comment_tmp2`.`register_time` AS `register_time`,`v_comment_tmp2`.`update_time` AS `update_time`,`v_comment_tmp2`.`user_key` AS `user_key`,`v_comment_tmp2`.`neckname` AS `neckname`,`v_comment_tmp2`.`icon` AS `icon`,`v_comment_tmp2`.`user_id` AS `user_id`,`v_comment_tmp2`.`target_id` AS `target_id`,`v_comment_tmp2`.`target_name` AS `target_name` from `v_comment_tmp2` union all select `v_comment_tmp3`.`id` AS `id`,`v_comment_tmp3`.`userkey` AS `userkey`,`v_comment_tmp3`.`targetkey` AS `targetkey`,`v_comment_tmp3`.`detail` AS `detail`,`v_comment_tmp3`.`pic1` AS `pic1`,`v_comment_tmp3`.`pic2` AS `pic2`,`v_comment_tmp3`.`pic3` AS `pic3`,`v_comment_tmp3`.`category` AS `category`,`v_comment_tmp3`.`display` AS `display`,`v_comment_tmp3`.`invalid` AS `invalid`,`v_comment_tmp3`.`register_time` AS `register_time`,`v_comment_tmp3`.`update_time` AS `update_time`,`v_comment_tmp3`.`user_key` AS `user_key`,`v_comment_tmp3`.`neckname` AS `neckname`,`v_comment_tmp3`.`icon` AS `icon`,`v_comment_tmp3`.`user_id` AS `user_id`,`v_comment_tmp3`.`target_id` AS `target_id`,`v_comment_tmp3`.`target_name` AS `target_name` from `v_comment_tmp3` ;
...
-- 视图结构 `v_comment_tmp0`
--
DROP TABLE IF EXISTS `v_comment_tmp0`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_comment_tmp0`  AS  select `c`.`id` AS `id`,`c`.`userkey` AS `userkey`,`c`.`targetkey` AS `targetkey`,`c`.`detail` AS `detail`,`c`.`pic1` AS `pic1`,`c`.`pic2` AS `pic2`,`c`.`pic3` AS `pic3`,`c`.`category` AS `category`,`c`.`display` AS `display`,`c`.`invalid` AS `invalid`,`c`.`register_time` AS `register_time`,`c`.`update_time` AS `update_time`,`u`.`id` AS `user_key`,`u`.`nickname` AS `neckname`,`u`.`icon` AS `icon`,`u`.`userid` AS `user_id` from (`comment` `c` left join `user` `u` on((`c`.`userkey` = `u`.`id`))) ;
...
-- 视图结构 `v_comment_tmp1`
--
DROP TABLE IF EXISTS `v_comment_tmp1`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_comment_tmp1`  AS  select `c1`.`id` AS `id`,`c1`.`userkey` AS `userkey`,`c1`.`targetkey` AS `targetkey`,`c1`.`detail` AS `detail`,`c1`.`pic1` AS `pic1`,`c1`.`pic2` AS `pic2`,`c1`.`pic3` AS `pic3`,`c1`.`category` AS `category`,`c1`.`display` AS `display`,`c1`.`invalid` AS `invalid`,`c1`.`register_time` AS `register_time`,`c1`.`update_time` AS `update_time`,`c1`.`user_key` AS `user_key`,`c1`.`neckname` AS `neckname`,`c1`.`icon` AS `icon`,`c1`.`user_id` AS `user_id`,`t`.`taskid` AS `target_id`,`t`.`server_name` AS `target_name` from (`v_comment_tmp0` `c1` left join `v_task` `t` on((`c1`.`targetkey` = `t`.`id`))) where (`c1`.`category` = '1') ;
...
-- 视图结构 `v_comment_tmp2`
--
DROP TABLE IF EXISTS `v_comment_tmp2`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_comment_tmp2`  AS  select `i2`.`id` AS `id`,`i2`.`userkey` AS `userkey`,`i2`.`targetkey` AS `targetkey`,`i2`.`detail` AS `detail`,`i2`.`pic1` AS `pic1`,`i2`.`pic2` AS `pic2`,`i2`.`pic3` AS `pic3`,`i2`.`category` AS `category`,`i2`.`display` AS `display`,`i2`.`invalid` AS `invalid`,`i2`.`register_time` AS `register_time`,`i2`.`update_time` AS `update_time`,`i2`.`user_key` AS `user_key`,`i2`.`neckname` AS `neckname`,`i2`.`icon` AS `icon`,`i2`.`user_id` AS `user_id`,`p`.`orderid` AS `target_id`,`p`.`req_name` AS `target_name` from (`v_comment_tmp0` `i2` left join `v_order_master` `p` on((`i2`.`targetkey` = `p`.`id`))) where (`i2`.`category` = '2') ;
...
-- 视图结构 `v_comment_tmp3`
--
DROP TABLE IF EXISTS `v_comment_tmp3`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_comment_tmp3`  AS  select `i3`.`id` AS `id`,`i3`.`userkey` AS `userkey`,`i3`.`targetkey` AS `targetkey`,`i3`.`detail` AS `detail`,`i3`.`pic1` AS `pic1`,`i3`.`pic2` AS `pic2`,`i3`.`pic3` AS `pic3`,`i3`.`category` AS `category`,`i3`.`display` AS `display`,`i3`.`invalid` AS `invalid`,`i3`.`register_time` AS `register_time`,`i3`.`update_time` AS `update_time`,`i3`.`user_key` AS `user_key`,`i3`.`neckname` AS `neckname`,`i3`.`icon` AS `icon`,`i3`.`user_id` AS `user_id`,`pp`.`user_id` AS `target_id`,`pp`.`neckname` AS `target_name` from (`v_comment_tmp0` `i3` left join `v_comment_tmp0` `pp` on((`i3`.`targetkey` = `pp`.`id`))) where (`i3`.`category` = '3') ;

-- --------------------------------------------------------

--
-- 视图结构 `v_consume_detail`
--
DROP TABLE IF EXISTS `v_consume_detail`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_consume_detail`  AS  select `o`.`id` AS `id`,`o`.`detailid` AS `detailid`,`o`.`taskkey` AS `taskkey`,`o`.`quantity` AS `quantity`,`o`.`status` AS `status`,`o`.`invalid` AS `invalid`,`o`.`register_time` AS `register_time`,`o`.`update_time` AS `update_time`,`u`.`name` AS `user_name`,`u`.`user_id` AS `user_id`,`u`.`icon` AS `user_icon` from (`consume_detail` `o` left join `v_task` `u` on((`o`.`taskkey` = `u`.`id`))) ;
...
-- 视图结构 `v_order_master`
--
DROP TABLE IF EXISTS `v_order_master`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_order_master`  AS  select `o`.`id` AS `id`,`o`.`orderid` AS `orderid`,`o`.`repair_userKey` AS `repair_userKey`,`o`.`outcome` AS `outcome`,`o`.`outcome_image1` AS `outcome_image1`,`o`.`outcome_image2` AS `outcome_image2`,`o`.`outcome_image3` AS `outcome_image3`,`o`.`status` AS `status`,`o`.`invalid` AS `invalid`,`o`.`register_time` AS `register_time`,`o`.`update_time` AS `update_time`,`u`.`name` AS `req_name`,`u`.`userid` AS `req_id`,`u`.`icon` AS `req_icon` from (`order_master` `o` left join `user` `u` on((`o`.`repair_userKey` = `u`.`id`))) where (`u`.`category` = '1') ;
...
-- 视图结构 `v_order_task`
--
DROP TABLE IF EXISTS `v_order_task`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_order_task`  AS  select `ort`.`id` AS `id`,`ort`.`taskKey` AS `taskKey`,`ort`.`orderKey` AS `orderKey`,`ort`.`invalid` AS `invalid`,`ort`.`register_time` AS `register_time`,`ort`.`update_time` AS `update_time`,`o`.`req_name` AS `req_name`,`o`.`req_id` AS `req_id`,`t`.`user_id` AS `user_id`,`t`.`name` AS `user_name` from ((`order_task` `ort` left join `v_order_master` `o` on((`ort`.`orderKey` = `o`.`id`))) left join `v_task` `t` on((`ort`.`taskKey` = `t`.`id`))) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_task`  AS  select `t`.`id` AS `id`,`t`.`taskid` AS `taskid`,`t`.`userkey` AS `userkey`,`t`.`serverKey` AS `serverKey`,`t`.`tip` AS `tip`,`t`.`epson` AS `epson`,`t`.`pro_description` AS `pro_description`,`t`.`pro_image1` AS `pro_image1`,`t`.`pro_image2` AS `pro_image2`,`t`.`pro_image3` AS `pro_image3`,`t`.`pro_image4` AS `pro_image4`,`t`.`pro_image5` AS `pro_image5`,`t`.`solve_image1` AS `solve_image1`,`t`.`solve_image2` AS `solve_image2`,`t`.`solve_image3` AS `solve_image3`,`t`.`seat` AS `seat`,`t`.`status` AS `status`,`t`.`invalid` AS `invalid`,`t`.`register_time` AS `register_time`,`t`.`update_time` AS `update_time`,`u`.`name` AS `name`,`u`.`userid` AS `user_id`,`u`.`icon` AS `icon`,`s`.`name` AS `server_name`,`s`.`price` AS `server_price`,((`s`.`price` + `t`.`tip`) + `t`.`epson`) AS `total_price` from ((`task` `t` left join `user` `u` on((`t`.`userkey` = `u`.`id`))) left join `re_serve` `s` on((`t`.`serverKey` = `s`.`id`))) ;

-- --------------------------------------------------------

--
-- 视图结构 `v_withdrawals_detail`
--
DROP TABLE IF EXISTS `v_withdrawals_detail`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_withdrawals_detail`  AS  select `o`.`id` AS `id`,`o`.`chargeid` AS `chargeid`,`o`.`userkey` AS `userkey`,`o`.`amount` AS `amount`,`o`.`status` AS `status`,`o`.`invalid` AS `invalid`,`o`.`register_time` AS `register_time`,`o`.`update_time` AS `update_time`,`u`.`name` AS `req_name`,`u`.`userid` AS `req_id`,`u`.`icon` AS `req_icon` from (`withdrawals_detail` `o` left join `user` `u` on((`o`.`userkey` = `u`.`id`))) where (`u`.`category` = '1') ;
...
--
-- Indexes for table `consume_detail`
--
ALTER TABLE `consume_detail`
  ADD PRIMARY KEY (`id`),
  ADD KEY `taskkey` (`taskkey`);

--
-- Indexes for table `mgr_user`
--
ALTER TABLE `mgr_user`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `order_master`
  ADD PRIMARY KEY (`id`),
  ADD KEY `repair_userKey` (`repair_userKey`);
...
--
-- Indexes for table `re_serve`
--
ALTER TABLE `re_serve`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `withdrawals_detail`
--
ALTER TABLE `withdrawals_detail`
  ADD PRIMARY KEY (`id`),
  ADD KEY `userkey` (`userkey`);
...
--
ALTER TABLE `charge_detail`
  ADD CONSTRAINT `charge_detail_ibfk_1` FOREIGN KEY (`userkey`) REFERENCES `user` (`id`);

--
-- 限制表 `comment`
--
ALTER TABLE `comment`
  ADD CONSTRAINT `comment_ibfk_1` FOREIGN KEY (`userkey`) REFERENCES `user` (`id`);

--
-- 限制表 `consume_detail`
--
ALTER TABLE `consume_detail`
  ADD CONSTRAINT `consume_detail_ibfk_1` FOREIGN KEY (`taskkey`) REFERENCES `task` (`id`);

--
-- 限制表 `order_master`
--
ALTER TABLE `order_master`
  ADD CONSTRAINT `order_master_ibfk_1` FOREIGN KEY (`repair_userKey`) REFERENCES `user` (`id`);

--
-- 限制表 `order_task`
--
ALTER TABLE `order_task`
  ADD CONSTRAINT `order_task_ibfk_1` FOREIGN KEY (`taskKey`) REFERENCES `task` (`id`),
  ADD CONSTRAINT `order_task_ibfk_2` FOREIGN KEY (`orderKey`) REFERENCES `order_master` (`id`);

--
-- 限制表 `task`
--
ALTER TABLE `task`
  ADD CONSTRAINT `task_ibfk_1` FOREIGN KEY (`userkey`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `task_ibfk_2` FOREIGN KEY (`serverKey`) REFERENCES `re_serve` (`id`);

--
-- 限制表 `withdrawals_detail`
--
ALTER TABLE `withdrawals_detail`
  ADD CONSTRAINT `withdrawals_detail_ibfk_1` FOREIGN KEY (`userkey`) REFERENCES `user` (`id`);
